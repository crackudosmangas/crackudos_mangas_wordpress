...
class FW_Db_Options_Model_Settings extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param mixed $value
		 */
		function fw_set_db_settings_option( $option_id = null, $value = null ) {
...
class FW_Db_Options_Model_Post extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param $value
		 */
		function fw_set_db_post_option( $post_id = null, $option_id = null, $value = null ) {
...
class FW_Db_Options_Model_Term extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @return null
		 */
		function fw_set_db_term_option( $term_id, $taxonomy, $option_id = null, $value = null ) {
			if ( ! taxonomy_exists( $taxonomy ) ) {
				return null;
			}
...
class FW_Db_Options_Model_Extension extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param mixed $value
		 */
		function fw_set_db_ext_settings_option( $extension_name, $option_id = null, $value = null ) {
...
class FW_Db_Options_Model_Customizer extends FW_Db_Options_Model {
	...
	protected function _init() {
		 ...
		 * @param mixed $value
		 */
		function fw_set_db_customizer_option( $option_id = null, $value = null ) {
 ...
 */
{
	 ...
	 * @param mixed $value
	 */
	function fw_set_db_extension_data( $extension_name, $multi_key = null, $value = null ) {
		if ( ! fw()->extensions->get( $extension_name ) ) {
			trigger_error( 'Invalid extension: ' . $extension_name, E_USER_WARNING );
